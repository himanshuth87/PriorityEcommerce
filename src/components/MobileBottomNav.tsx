...
export const MobileBottomNav = ({ onSearchOpen }: { onSearchOpen: () => void }) => {
  ...
  return (
    <div className="lg:hidden fixed bottom-4 left-1/2 -translate-x-1/2 z-[100] w-[92%] max-w-[380px]">
      <motion.nav
        initial={{ y: 20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        className="bg-black/85 dark:bg-white/10 backdrop-blur-2xl border border-white/10 rounded-full py-2.5 px-5 shadow-2xl shadow-black/30 flex items-center justify-between"
      >
