...
export const PRODUCTS: Product[] = [
  ...
  productTemplate({
    ...
    variants: [
      { color: 'Dusk Blue', colorCode: '#1F83B7', images: [IMG.backpack1, IMG.backpack2, IMG.backpack3] },
      { color: 'Midnight Navy', colorCode: '#0B182E', images: [IMG.backpack2, IMG.backpack1, IMG.backpack3] },
      { color: 'Classic Crimson', colorCode: '#E01F26', images: [IMG.backpack3, IMG.backpack1, IMG.backpack2] },
      { color: 'Asphalt Grey', colorCode: '#303030', images: [IMG.backpack1, IMG.backpack3, IMG.backpack2] },
    ],
